...
export const MidClusterCTA = ({ relatedArticles, stage, currentArticleId }: MidClusterCTAProps) => {
  ...
  return (
    <motion.div
      ...
      className="my-12 bg-gradient-to-br from-primary/10 via-primary/5 to-background border border-primary/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300"
    >
      {cta.featured_image_url && (
        <div className="w-full h-48 md:h-64 overflow-hidden">
          <img 
            src={cta.featured_image_url} 
            alt={cta.headline}

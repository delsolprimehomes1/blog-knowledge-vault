...
export const BlogFooter = () => {
  ...
  return (
    <footer ref={elementRef as React.RefObject<HTMLElement>} className="relative mt-16 overflow-hidden">
      ...
      <div className="relative glass-premium">
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {/* Company Info */}
            <div className="space-y-5">
              <h3 className="text-2xl font-display font-bold bg-gradient-to-r from-primary via-white to-primary bg-clip-text text-transparent">
                DelSol Prime Homes
              </h3>
              ...
              <div className="flex gap-3 pt-2">
                <a href="#" className="group relative p-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-primary/20 hover:border-primary/40 transition-all duration-300 hover-scale">
            ...
            {/* Contact Information */}
            <div className="space-y-5">
              <h3 className="text-lg font-semibold text-white font-display">Contact Us</h3>
              <div className="flex flex-col space-y-4">
                <div className="group flex items-start gap-3 p-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-primary/30 transition-all duration-300">
                ...
                <a 
                  ...
                  className="group flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-primary/30 transition-all duration-300 hover-scale"
                >
                  <div className="p-2 rounded-md bg-primary/20 group-hover:bg-primary/30 transition-colors">
                ...
                <a 
                  ...
                  className="group flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-primary/30 transition-all duration-300 hover-scale break-all"
                >
                  <div className="p-2 rounded-md bg-primary/20 group-hover:bg-primary/30 transition-colors">
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 p-3 rounded-full bg-primary/90 hover:bg-primary text-white shadow-lg hover-glow transition-all duration-300 hover-scale z-50 backdrop-blur-sm border border-white/10"

...
export const SEOMetaSection = ({
  ...
  const autoGeneratedCanonical = `https://delsolprimehomes.com/blog/${slug}`;
  const effectiveCanonical = canonicalUrl || autoGeneratedCanonical;
        ...
        <div>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-md p-3 mt-2">
            <p className="text-xs font-medium text-foreground mb-1">
              🔗 Canonical URL to be saved:
            </p>
            <code className="text-xs text-primary break-all">
              {effectiveCanonical}
            </code>
            <p className="text-xs text-muted-foreground mt-1">
              ✅ Auto-generated from article slug
            </p>
          </div>
        </div>
      </CardContent>
